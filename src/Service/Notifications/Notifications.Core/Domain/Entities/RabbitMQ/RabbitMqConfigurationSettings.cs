...
namespace Notifications.Core.Domain.Entities.RabbitMQ
{
    public class RabbitMqConfigurationSettings
    {
        ...
        public Uri GetQueueAdressPaymentProcessedEvent() => new Uri($"amqp://{Username}:{Password}@{HostName}:5672/{QueueNamePaymentProcessedEvent}");
    }
}
